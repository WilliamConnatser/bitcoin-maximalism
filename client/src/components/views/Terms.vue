<template>
    <div class="normal-text">
        ...
        contained herein (the "Terms"). Your use of www.BitcoinMaximalism.com constitutes your agreement to all
        ...
        cryptocurrencies in general. Don't blindly trust us, or blindly trust any of the information contained
        within (or linked to) the Site, but instead verify the information by leveraging other independent
        resources. Knowledge is power. Don't trust- verify.<br /><br />
        ...
        which could cause any forward-looking statements contained within the Site to be untrue, but at the
        same time this is not meant to be an exhaustive list of all risk factors. Any forward-looking
        statements contained within the Site do not neccessarily represent the beliefs of YOLO or its
        affiliates, but are instead meant to be a cursory outline of beliefs that YOLO has deduced are
        generally believed to be true, both by Bitcoin Maximalism protagonists and antagonists.<br /><br />

        The information contained in this document may include, or incorporate by reference, forward-looking
        statements, which would include any statements that are not statements of historical fact. These
        forward-looking statements may turn out to be wrong and can be affected by inaccurate assumptions or by
        known or unknown risks, uncertainties and other factors, most of which are beyond YOLO's control.
        Investors should conduct independent due diligence, with assistance from professional financial, legal
        and tax experts, on all cryptocurrencies discussed on the Site, and develop a stand-alone judgment of
        the relevant markets prior to making any investment decision.<br /><br />
        ...
        guarantees, expressed or implied, that the information contained within this web site is true or
        accurate, because many statements involve incomplete information, forward-looking statements.
        Furthermore, the topic of most subjects contained within the Site invole complex issues regarding
        untested theories having to do with new paradigms which span many subject matters simultaneously, such
        as economics, politics, game theory, and multiple subsets of computer science.<br /><br />

        The Site is for informational and entertainment purposes only, and is not intended as official and
        undeniable doctrine, nor as an official confirmation of any transaction. All market prices, data and
        other information are not warranted as to completeness or accuracy, are based upon selected public
        market data, and reflect prevailing conditions and YOLO's perception of the cryptocurrency community's
        views as of this date, all of which are accordingly subject to change without notice. YOLO has no
        obligation to continue offering the information published or updates regarding information contained on
        the Site. Information may become unreliable after publication because of subsequent market or economic
        circumstances.<br /><br />
        ...
        (also known as tokens, alt coins, or alternative cryptocurrencies) mentioned throughout various pages
        on the Site, and stand to realize gains in the event that the price of the cryptocurrency increases or
        decreases. Following publication of information on the Site, the Researchers may transact in the
        cryptocurrencies mentioned. All content on the Site represents either the opinion of the Researchers,
        or an existing sentiment the Reasearchers have deduced exists within the cryptocurrency community. YOLO
        has obtained all information contained within the Site from sources they believe to be accurate and
        reliable. However, such information is presented “as is,” without warranty of any kind – whether
        express or implied.<br /><br />
        ...
        cryptocurrency, and is not expressed as, or implied as, assessments of the quality of any certain
        cryptocurrency, a summary of past performance, or an actionable investment strategy for an investor.
        The Site does not in any way constitute an offer or solicitation of an offer to buy or sell any
        investment or cryptocurrency discussed herein.<br /><br />
        ...
        or through other forms of payment, you are explicitly agreeing that any value conveyed is to be
        considered as charitable donations that are not subject to refund under any circumstances. All
        donations carry with them no guarantees, expressed or implied, that any services will be rendered in
        return. This includes no guarantees that the memo contained within the donationation transaction will
        be published on the Site. For any and all reasons it feels are neccessary, YOLO reserves the right to
        censor any statement made in these donation memos on the Site by simply not publishing it without
        providing any refunds. The risk of censorship on the web site should be kept in mind when making
        donations to the Site.<br /><br />

        <b>Not Responsible For Users' Statements</b><br />
        Any statements made and published on the Site, which are contained within the memos of user donations
        made through various cryptocurrency transactions, are to be considered as being their own views which
        are not neccessarily shared or endorsed by YOLO. Undeniable cryptographic proof that the user's
        statements are of their own creation can be found publicly by referrencing the transparent blockchain
        of the applicable cryptocurrency the donation was made with. YOLO must not be held responsible for any
        statements made by our users, no matter if the statements are false or intentionally misleading,
        although the Site will make a best effort to ensure that does not occur.<br /><br />
        ...
        legal requirement that such communications be in writing.<br /><br />
        ...
        services provided in return of said donations, expressed or implied.<br /><br />
        ...
        Site. YOLO is providing these links to you only as a convenience, and the inclusion of any link does
        not imply endorsement by YOLO of the site or any association with its operators.<br /><br />

        Certain services made available via www.BitcoinMaximalism.com are delivered by third party sites and
        organizations. By using any product, service or functionality originating from the
        www.BitcoinMaximalism.com domain, you hereby acknowledge and consent that YOLO may share such
        information and data with any third party with whom YOLO has a contractual relationship to provide the
        requested product, service or functionality on behalf of www.BitcoinMaximalism.com users and customers.<br /><br />
        ...
        made available or provided for through the Site.<br /><br />

        All content included as part of the Service, such as text, graphics, logos, images, as well as the
        compilation thereof, and any software used on the Site, is the property of YOLO or its suppliers and
        ...
        restrictions contained in any such content and will not make any changes thereto.<br /><br />

        You will not modify, publish, transmit, reverse engineer, participate in the transfer or sale, create
        derivative works, or in any way exploit any of the content, in whole or in part, found on the Site.
        YOLO content is not for resale. Your use of the Site does not entitle you to make any unauthorized use
        ...
        will make no other use of the content without the express written permission of YOLO and the copyright
        owner. You agree that you do not acquire any ownership rights in any protected content. We do not grant
        you any licenses, express or implied, to the intellectual property of YOLO or our licensors except as
        ...
        proper and related to the particular Communication Service.<br /><br />
        ...
        necessary consents; upload files that contain viruses, corrupted files, or any other similar software
        or programs that may damage the operation of another's computer; advertise or offer to sell or buy any
        ...
        e-mail addresses, without their consent; violate any applicable laws or regulations.<br /><br />

        YOLO has no obligation to monitor the Communication Services. However, YOLO reserves the right to
        review materials posted to a Communication Service and to remove any materials in its sole discretion.
        YOLO reserves the right to terminate your access to any or all of the Communication Services at any
        time without notice for any reason whatsoever.<br /><br />

        YOLO reserves the right at all times to disclose any information as necessary to satisfy any applicable
        law, regulation, legal process or governmental request, or to edit, refuse to post or to remove any
        information or materials, in whole or in part, in YOLO's sole discretion.<br /><br />

        Always use caution when giving out any personally identifying information about yourself or your
        children in any Communication Service. YOLO does not control or endorse the content, messages or
        information found in any Communication Service and, therefore, YOLO specifically disclaims any
        liability with regard to the Communication Services and any actions resulting from your participation
        in any Communication Service. Managers and hosts are not authorized YOLO spokespersons, and their views
        do not necessarily reflect those of YOLO.<br /><br />
        ...
        Submission you are granting YOLO, our affiliated companies and necessary sublicensees permission to use
        ...
        No compensation will be paid with respect to the use of your Submission, as provided herein. YOLO is
        under no obligation to post or use any Submission you may provide and may remove any Submission at any
        time in YOLO's sole discretion.<br /><br />
        ...
        any country or in any manner prohibited by any applicable laws, restrictions or regulations.<br /><br />
        ...
        party, or your violation of any applicable laws, rules or regulations. YOLO reserves the right, at its
        own cost, to assume the exclusive defense and control of any matter otherwise subject to
        indemnification by you, in which event you will fully cooperate with YOLO in asserting any available
        defenses.<br /><br />
        ...
        arbitration provision shall survive the termination of these Terms and Conditions.<br /><br />
        ...
        OF A PRIVATE ATTORNEY GENERAL ACTION AGAINST THE OTHER. Further, unless both you and YOLO agree
        otherwise, the arbitrator may not consolidate more than one person's claims, and may not otherwise
        preside over any form of a representative or class proceeding.<br /><br />
        ...
        International LLC AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR CHANGES IN THE SITE AT ANY TIME.<br /><br />

        YOLO International LLC AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE SUITABILITY, RELIABILITY,
        ...
        WARRANTY OR CONDITION OF ANY KIND. YOLO International LLC AND/OR ITS SUPPLIERS HEREBY DISCLAIM ALL
        ...
        PURPOSE, TITLE AND NON-INFRINGEMENT.<br /><br />

        TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT SHALL YOLO International LLC AND/OR ITS
        ...
        OTHERWISE, EVEN IF YOLO International LLC OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE POSSIBILITY
        OF DAMAGES. BECAUSE SOME STATES/JURISDICTIONS DO NOT ALLOW THE EXCLUSION OR LIMITATION OF LIABILITY FOR
        ...
        DISCONTINUE USING THE SITE.<br /><br />
        ...
        jurisdiction and venue of courts in Texas in all disputes arising out of or relating to the use of the
        Site. Use of the Site is unauthorized in any jurisdiction that does not give effect to all provisions
        of these Terms, including, without limitation, this section.<br /><br />

        You agree that no joint venture, partnership, employment, or agency relationship exists between you and
        YOLO as a result of this agreement or use of the Site. YOLO's performance of this agreement is subject
        to existing laws and legal process, and nothing contained in this agreement is in derogation of YOLO's
        right to comply with governmental, court and law enforcement requests or requirements relating to your
        use of the Site or information provided to or gathered by YOLO with respect to such use. If any part of
        this agreement is determined to be invalid or unenforceable pursuant to applicable law including, but
        ...
        matches the intent of the original provision and the remainder of the agreement shall continue in
        effect.<br /><br />

        Unless otherwise specified herein, this agreement constitutes the entire agreement between the user and
        YOLO with respect to the Site and it supersedes all prior or contemporaneous communications and
        proposals, whether electronic, oral or written, between the user and YOLO with respect to the Site. A
        ...
        documents be written in English.<br /><br />
        ...
        versions. YOLO encourages you to periodically review the Terms to stay informed of our updates.<br /><br />

        <b>Contact Us</b><br />
        YOLO welcomes your questions or comments regarding the Terms:<br /><br />

        YOLO International LLC<br />
        3206 Longmire Drive Suite A42<br />
        College Station, Texas 77845<br /><br />

        Email Address:<br />
        admin@BitcoinMaximalism.com<br /><br />

        Effective as of September 28, 2018<br /><br />
    </div>
</template>
