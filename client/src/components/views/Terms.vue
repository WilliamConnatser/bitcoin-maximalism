<template>
    <section class="normal-text">
        ...
        <p>
            ...
            generally believed to be true, both by Bitcoin Maximalism protagonists and antagonists.
        </p>
        ...
        <p>
            ...
            accurate because many statements involve incomplete information and forward-looking statements.
            Furthermore, the topic of most subjects contained within the Site invole complex issues regarding
            untested theories having to do with new paradigms that span many subject matters simultaneously, such
            as economics, politics, game theory, and multiple subsets of computer science.
        </p>
        ...
        <p>
            ...
            investment or cryptocurrency discussed herein.
        </p>
        ...
        <p>
            ...
            return. This includes no guarantees that your opinions will be published on the Site, nor does it
            provide any guarantee that features won't be implemented (or deprecated) in the future which reduce
            (or increase) the weight of your upvotes or downvotes. For any and all reasons it feels are neccessary,
            YOLO reserves the right to censor and remove any statement made in opinions posted on the Site by
            removing the opinion or editing the opinion without providing any refund. The risk of censorship on
            the web site should be kept in mind when making donations to the Site and when writing opinions.
        </p>
        ...
        <p>
            ...
            no matter if the statements are found to be provably false or intentionally misleading. The Site 
            will make a best effort attempt to ensure such deception does not occur.
        </p>
        ...
        <p>
            ...
            not imply endorsement by YOLO of the site or any association with its operators.
        </p>
        ...
        <p>
            ...
            requested product, service or functionality on behalf of www.BitcoinMaximalism.com users and customers.
        </p>
        ...
        <p>
            ...
            information or materials, in whole or in part, in YOLO's sole discretion.
        </p>
        ...
        <p>
            ...
            do not necessarily reflect those of YOLO.
        </p>
        ...
        <p>
            ...
            time in YOLO's sole discretion.
        </p>
        ...
        <p>YOLO International LLC AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE SUITABILITY, RELIABILITY,
