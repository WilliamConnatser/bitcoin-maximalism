<template>
    <div class="container normal-text">
        ...
        <div class="medium-margin">
            ...
            BitcoinMaximalism.com is a highly-specific social media platform based solely on the nuance surrounding the <strong>Bitcoin Maximalism</strong> and
            <strong>Multicoinism</strong> investment theses. Each participants' influence is directly proportional to the amount of
