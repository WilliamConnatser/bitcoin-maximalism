const state = {
    protagonistic: [{
        ...
        },
        {
            ...
            resources: [{
                name: 'Bitcoin Maximalism Dissected - Giacomo Zucco',
                type: 'video',
                link: 'https://youtu.be/D2WXxgZ8h-0?t=700'
            }, {
                name: 'Making the strongest case for small blocks - Sosthène',
                type: 'blog',
                link: 'https://www.sosthene.net/strongest-case-small-blocks/'
            }, {
                name: 'The Bullish Case For Bitcoin - Vijay Boyapati',
                type: 'blog',
                link: 'https://medium.com/@vijayboyapati/the-bullish-case-for-bitcoin-6ecc8bdecc1'
            }, {
                name: 'Bitcoin: A $5.8 Million Valuation - Mr. Game & Watch',
                type: 'whitepaper',
    ...
    antagonistic: [{
            ...
            bulletPoints: [
                'Alternative cryptocurrencies create more tokens on top of the initial 21 million Bitcoins that will ever exist. It is for this reason that Bitcoin Maximalists usually consider ALT coins as being inflationary to Bitcoin. They usually go on to highlight the fact that an infinite amount of alternative cryptocurrencies will be created in the future. However, these types of arguments ignore the highly nuanced phenomena that are alternative cryptocurrencies. Bitcoin is not perfect for numerous reasons, and it is quite unlikely that Bitcoin will ever be able to fulfill every use case that alternative cryptocurrencies have the potential to disrupt. ALT coin proponents believe that their chosen cryptocurrency has improved upon one (or more) of Bitcoin\'s flaws, and it is for this reason that Multicoinists believe ALT coins are more likely to succeed than Bitcoin.',
        ...
        },
        {
            ...
            resources: [{
                name: 'The Case For Ethereum Maximalism - Eli Dourado',
                type: 'blog',
                link: 'https://blog.elidourado.com/the-case-for-ethereum-maximalism-e6ec5dc7f7b2'
            }, {
                name: 'On Bitcoin Maximalism, and Currency and Platform Network Effects - Vitalik Buterin',
                type: 'blog',
                link: 'https://blog.ethereum.org/2014/11/20/bitcoin-maximalism-currency-platform-network-effects/'
            }, {
                name: 'Sidechains Don\'t Scale - Noah Ruderman',
                type: 'blog',
